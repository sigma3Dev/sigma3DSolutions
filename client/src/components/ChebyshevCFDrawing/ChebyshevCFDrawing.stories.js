...
stories.add(
  'Drawing to display the result of the calculated chebyshev circle fit adjustment especially radius and chebyshev distance',
  () => {
...
stories.add('chebyshev circle with 100 circle points in svg', () => {
  const radius = (200.0).toFixed(2);
  const chebyDist = (20.0).toFixed(2);
  const points = [
    { x: 210.0, y: 0.0 },
    { x: 190.0, y: 0.0 },
    { x: 199.51, y: 16.95 },
...
stories.add('chebyshev circle with circle points in svg (scale=1)', () => {
  const radius = (200.0).toFixed(2);
  const chebyDist = (80.0).toFixed(2);
  const points = [
    { x: 200.0, y: 0.0 },
    { x: 193.19, y: 51.76 },
    { x: 173.21, y: 100.0 },
